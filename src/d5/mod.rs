...
mod tests {
    ...
    fn p1() {
        ...
        seed1("src/d5/input.txt");
        // assert_eq!(seed1("src/d4/input.txt"), 27454);
    }

    // #[test]
    // fn p2() {
    //     assert_eq!(seed2("src/d4/input_test1.txt"), 30); // provided test
    //     assert_eq!(seed2("src/d4/input.txt"), 6857330);
    // }
}
